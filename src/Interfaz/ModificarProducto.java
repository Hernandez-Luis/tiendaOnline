...
public class ModificarProducto extends JFrame {
    ...
    private JButton eliminar,regresar,modificar,actualizar;
    private JLabel vacio1,vacio2,vacio3,vacio4,abarrotes,lacteos,articulos,embutidos,blanca,nombre,marca,cantidad,descripcion,precio,departamento;
    ...
    public void modificar(){
        int d =abarrotesL.getSelectedIndex();
        int e =lacteosL.getSelectedIndex();
        int f =articulosL.getSelectedIndex();
        int g =embutidosL.getSelectedIndex();
        int h =blancaL.getSelectedIndex();
        ...
        if (departamento.equals("Abarrotes")){
            listaAbarrote.add(d,new Productos(nombre,marca,cantidad,descripcion,precio,departamento));

        } else if (departamento.equals("Lacteos")) {
            listaLacteos.add(e,new Productos(nombre,marca,cantidad,descripcion,precio,departamento));
        } else if (departamento.equals("Articulos de limpieza")) {
            listaArticulos.add(f,new Productos(nombre,marca,cantidad,descripcion,precio,departamento));
        }else if (departamento.equals("Embutidos")){
            listaEmbutidos.add(g,new Productos(nombre,marca,cantidad,descripcion,precio,departamento));
        } else if (departamento.equals("Linea blanca")) {
            listaBlanca.add(h,new Productos(nombre,marca,cantidad,descripcion,precio,departamento));
        }
    }
